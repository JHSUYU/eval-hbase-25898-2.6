...
@javax.annotation.Generated("proto") public final class TestRpcServiceProtos {
   ...
   * </pre>
   *
   * Protobuf service {@code hbase.test.pb.TestProtobufRpcProto}
   */
  public static abstract class TestProtobufRpcProto
    ...
    public interface Interface {
      /**
       * <code>rpc ping(.hbase.test.pb.EmptyRequestProto) returns (.hbase.test.pb.EmptyResponseProto);</code>
       */
      ...
      /**
       * <code>rpc echo(.hbase.test.pb.EchoRequestProto) returns (.hbase.test.pb.EchoResponseProto);</code>
       */
      ...
      /**
       * <code>rpc error(.hbase.test.pb.EmptyRequestProto) returns (.hbase.test.pb.EmptyResponseProto);</code>
       */
      ...
      /**
       * <code>rpc pause(.hbase.test.pb.PauseRequestProto) returns (.hbase.test.pb.EmptyResponseProto);</code>
       */
      ...
      /**
       * <code>rpc addr(.hbase.test.pb.EmptyRequestProto) returns (.hbase.test.pb.AddrResponseProto);</code>
       */
    ...
    // @@protoc_insertion_point(class_scope:hbase.test.pb.TestProtobufRpcProto)
  }
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\026test_rpc_service.proto\022\rhbase.test.pb\032" +
      "\ntest.proto2\226\003\n\024TestProtobufRpcProto\022K\n\004" +
      "ping\022 .hbase.test.pb.EmptyRequestProto\032!" +
      ".hbase.test.pb.EmptyResponseProto\022I\n\004ech" +
      "o\022\037.hbase.test.pb.EchoRequestProto\032 .hba" +
      "se.test.pb.EchoResponseProto\022L\n\005error\022 ." +
      "hbase.test.pb.EmptyRequestProto\032!.hbase." +
      "test.pb.EmptyResponseProto\022L\n\005pause\022 .hb" +
      "ase.test.pb.PauseRequestProto\032!.hbase.te" +
      "st.pb.EmptyResponseProto\022J\n\004addr\022 .hbase" +
      ".test.pb.EmptyRequestProto\032 .hbase.test." +
      "pb.AddrResponseProtoBS\n5org.apache.hadoo" +
      "p.hbase.shaded.ipc.protobuf.generatedB\024T" +
