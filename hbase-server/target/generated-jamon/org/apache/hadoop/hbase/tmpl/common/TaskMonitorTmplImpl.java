...
// /Users/lizhenyu/Desktop/Evaluation/hbase-25898/hbase-server/src/main/jamon/org/apache/hadoop/hbase/tmpl/common/TaskMonitorTmpl.jamon
      ...
      else
      {
        ...
        for (MonitoredTask task : tasks )
        {
          ...
          else
          {
            ...
            jamonWriter.write("\n                          ");
            // 124, 27
            org.jamon.escaping.Escaping.HTML.write(org.jamon.emit.StandardEmitter.valueOf(new Date(task.getCompletionTimestamp())), jamonWriter);
            // 124, 72
            jamonWriter.write(" (since ");
            // 124, 80
            org.jamon.escaping.Escaping.HTML.write(org.jamon.emit.StandardEmitter.valueOf(StringUtils.formatTimeDiff(now, task.getCompletionTimestamp())), jamonWriter);
            // 124, 148
            jamonWriter.write(" ago)\n                        ");
          }
          // 125, 31
